...
uc_campuses <- tribble(
  ...
  "UC Davis",            -121.7446,   38.5382,
  "UC Irvine",           -117.8443,   33.6405,
  "UCLA",                -118.4452,   34.0689,
  "UC Merced",           -120.4189,   37.3649,
  "UC Riverside",        -117.3281,   33.9737,
  "UC San Diego",        -117.2394,   32.8801,
  "UC San Francisco",    -122.4580,   37.7631,
  "UC Santa Barbara",    -119.8489,   34.4139,
  "UC Santa Cruz",       -122.0622,   36.9916
)

uc_sf <- st_as_sf(uc_campuses, coords = c("Longitude", "Latitude"), crs = 4326) |> 
  st_transform(3310)
```
...
for (i in 1:nrow(uc_sf)) {
  ...
  buffer_1 <- st_buffer(campus_pt, 1609)
  buffer_3 <- st_buffer(campus_pt, 1609 * 3)
  buffer_5 <- st_buffer(campus_pt, 1609 * 7)
...
for (i in 1:nrow(uc_sf)) {
  ...
  buffer_1 <- st_buffer(campus_pt, 1609)
  buffer_3 <- st_buffer(campus_pt, 1609 * 3)
  buffer_5 <- st_buffer(campus_pt, 1609 * 15)
